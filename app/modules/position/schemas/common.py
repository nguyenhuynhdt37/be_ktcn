...
def build_position_resolved(data: Any) -> dict:
    """
    Helper chuyển đổi object Position db sang dictionary phẳng
    ...
    translations_dict = {
        "vi": {"name": "", "description": "", "is_translated": False},
        "en": {"name": "", "description": "", "is_translated": False}
    }
    is_translated = {
        "vi": False,
        "en": False
...
class TranslationItemResponse(BaseModel):
    """Schema cho từng bản dịch của Position."""
...
class PositionCreate(BaseModel):
    ...
    sort_order: int = 0
    is_active: bool = True
    translations: dict[str, TranslationItemResponse] = Field(..., description="Bản dịch chức vụ")


class PositionUpdate(BaseModel):
    """Payload cập nhật chức vụ."""
