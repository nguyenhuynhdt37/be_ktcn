...
from app.modules.degree.schemas import DegreeAdminResponse, DegreePortalResponse
from app.modules.degree.service import DegreeService

admin_router = APIRouter(prefix="/degrees", tags=["Admin Degrees"])
portal_router = APIRouter(prefix="/degrees", tags=["Portal Degrees"])
